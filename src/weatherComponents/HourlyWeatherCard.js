...
function HourlyWeatherCard(props) {
    if (props.index != 0) {
        return (
            ...
            <div style={{ borderWidth: 5, backgroundColor: "lightgray", color: "black", width: "40%", shadowColor: "black", shadowOpacity: 5.8, shadowRadius: 2, shadowOffset: { height: 100, width: 100 } }} >
